...
$lang = array_merge($lang, array(
	...
	'RULES'							=> '<ol>
											...
											<li>You may only rate trades, which are connected to the GPC. This means:
												<ul>
													...
													<li><div style="color: green">right:<ul>
															<li>Trades that are organized in the <a href="viewforum.php?f=27">Pen-Trading-Section</a>.</li>
															<li>Trades on gatherings, that are organized in the <a href="viewforum.php?f=25">Treffen / Gatherings-Section</a>.</li></ul>
														</div>
													</li>
												</ul>
											...
											<li>If you think that you got a unfair rating, you should contact a moderator of our <a href="memberlist.php?mode=group&g=3" class="postlink" rel="nofollow"><span style="text-decoration: underline">team</span></a> and your tradepartner.</li>
											<li>Rate meanings:
