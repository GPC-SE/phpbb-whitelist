											...
											<li>Nur Trades bewerten, die in Bezug zur GPC stehen:
												<ul>
													...
													<li><div style="color: green">richtig:<ul>
															<li>Über den <a href="http://localhost/phpBB3/viewforum.php?f=27">Pen-Trading-Bereich</a> organisierte Trades.</li>
															<li>Trades auf Gatherings, die über den <a href="http://localhost/phpBB3/viewforum.php?f=25">Treffen / Gatherings-Bereich</a> organisiert wurden.</li></ul>
														</div>
													</li>
												</ul>
											<li>Falsche Angaben führen von einem Abzug positiver Bewertungen über negativ Einträge bis hin zum Ausschluss.</li>
											<li>Solltest du dich ungerecht bewertet fühlen, so wende dich bitte an einen Moderator des <a href="http://forum.penspinning.de/memberlist.php?mode=leaders" class="postlink" rel="nofollow"><span style="text-decoration: underline">Teams</span></a> und an deinen Tradepartner.</li>
